...
public class WebServiceConfiguration {
	...
	public WSS4JOutInterceptor wss4jOut() {
		...
		properties.put(ConfigurationConstants.SIG_ALGO, "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256");
